...
variable "efs_wait_for_jobs"{
  type = bool
}
variable "efs_max_history"{
  type = number
}

variable "eks_max_unavailable_percent"{
  type = number
}
...
variable "alb_cleanup_on_fail"{
  type = bool
}
variable "alb_wait"{
  type = bool
}
variable "alb_wait_for_jobs"{
  type = bool
}
